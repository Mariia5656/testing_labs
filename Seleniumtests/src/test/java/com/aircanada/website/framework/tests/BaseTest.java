package com.aircanada.website.framework.tests;

import com.aircanada.website.framework.core.tests.BeforeAndAfterTestMethods;
import com.aircanada.website.framework.pages.FlightStatusPage;
import com.aircanada.website.framework.pages.main.*;
...
public class BaseTest extends BeforeAndAfterTestMethods {
    ...
    public void moreThanTenAdultPassengersErrorTest() {
        ...
        FlightsTabPage page = new MainPage()
                .open()
                .openFlightsTab()
    ...
    public void incorrectFlightSearchTest() {
        ...
        FlightStatusPage page = new MainPage()
                .open()
                .openFlightStatusTab()
    ...
    public void incorrectMyBookingDataTest() {
        ...
        MyBookingsTabPage page = new MainPage()
                .open()
                .openMyBookingsTab()
    ...
    public void incorrectCheckInDataTest() {
        ...
        CheckInTabPage page = new MainPage()
                .open()
                .openCheckInTab()
    ...
    public void hotelsIncorrectDayIntevalTest() {
        ...
        HotelsTabPage page = new MainPage()
                .open()
                .openHotelsTab()
                .setLocation("Moscow")
                .setFirstAvailableStartDate()
