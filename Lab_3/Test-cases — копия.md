ТЕСТ КЕЙСЫ
CООБЩЕНИЕ-УВЕДОМЛЕНИЕ ПРИ ВЫБОРЕ МАКСИМАЛЬНО ДОПУСТИМОГО ЧИСЛА ПАССАЖИРОВ:
Set up:
...
СООБЩЕНИЕ О НЕВОЗМОЖНОСТИ ПУТЕШЕСТВИЯ РЕБЕНКА ВОЗРАСТОМ МЕНЬШЕ 8 БЕЗ СОПРОВОЖДЕНИЯ ВЗРОСЛОГО:
Set up:
Зайти на www.aircanada.com
Steps:
1.	В форме бронирования находим поле PASSANGERS
...
ПОИСК СТАТУСА ПОЛЕТА НЕВОЗМОЖЕН:
Set up:
Зайти на www.aircanada.com
Steps:
...
СООБЩЕНИЕ ОБ ОШИБКЕ ПРИ ВВОДЕ НЕПРАВИЛЬНОГО ГОРОДА:
Set up:
Зайти на www.aircanada.com
Steps:
...
НЕВОЗМОЖНОСТЬ ВЫБОРА ДАТЫ ПРИЛЕТА РАНЕЕ ДАТЫ ВЫЛЕТА:
Set up:
Зайти на www.aircanada.com
Steps:
...
ПРОСМОТР МОИХ ЗАКАЗОВ И ПОЛЕТОВ:
Set up:
Зайти на www.aircanada.com
Steps:
...
ПРОЦЕНТ БРОНИ В КОНКРЕТНОЙ ГОСТИНИЦЕ УВЕЛИЧИВАЕТСЯ:
Set up:
Зайти на www.aircanada.com
Steps:
...
НЕВОЗМОЖНОСТЬ ВОЗВРАТА АВТОМОБИЛЯ РАНЬШЕ ВРЕМЕНИ ЕГО ВЫЗОВА:
Set up:
Зайти на www.aircanada.com
Steps:
